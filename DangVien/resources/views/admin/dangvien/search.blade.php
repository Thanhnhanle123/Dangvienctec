                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a class="btn btn-success float-right m-2" href="{{ route('dangvien.create') }}">ADD</a>
                            <a class="btn  btn-outline-dark float-right m-2 c " href="{{ route('dangvien.danhsach') }}" data-url=""><i class="fas fa-backspace"> Hủy lọc </i></a>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            ...
                            @foreach ($dangVien as $dv)
                                ...
                                <td>
                                    <a class="btn btn-danger m-3" onclick="return confirm('Bạn có chắc muốn xóa không ?')" href="{{ route('dangvien.delete',['id' => $dv->id]) }}"><i class="fas fa-trash-alt"></i></a>
                                </td>
                                <td> --}}
                                <td>
