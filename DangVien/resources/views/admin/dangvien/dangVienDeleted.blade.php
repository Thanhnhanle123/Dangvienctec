...
@section('Content')
    <div class="wrapper">
        <div class="content-wrapper">
            @include('partials.content_header',['name'=>'Đảng Viên đã xóa','title'=>'Danh sách','route' => 'dangvien.danhsach'])
            <!-- Main content -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            {{-- <div class="card-header">
                                <a class="btn btn-success show-deleted"><i class="fas fa-trash"></i></a>
